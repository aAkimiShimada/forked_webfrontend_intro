...
const CounterButton = memo((props: CounterButtonProps) => {
...
const Counter: FC<CounterProps> = (props) => {
  ...
  const handleStartCount = useCallback((e: React.MouseEvent<HTMLButtonElement>) => {
  ...
  const handleStopCount = useCallback((e: React.MouseEvent<HTMLButtonElement>) => {
